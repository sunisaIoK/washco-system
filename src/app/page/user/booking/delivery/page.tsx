  ...
  return (
    <main className="flex flex-col mr-12 ml-16 p-9">
      <div className="flex justify-between items-center mb-3">
        <h1 className="text-2xl font-bold ml-8">จัดการข้อมูลเดลิเวอรี่</h1>
        <button
          onClick={() => setIsAddModalOpen(true)}
          className="bg-blue-500 text-white hover:bg-blue-600 px-4 py-2 mr-12 rounded flex items-center"
        >
                ...
                <tr key={delivery.id} className="hover:bg-gray-100 ">
                  ...
                  <td className="border border-gray-300 p-3 text-center">
                    <button
                      ...
                      className={`px-3 py-1  rounded ${delivery.isActive ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'}`}
                    >
